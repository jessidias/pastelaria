...
if ($categoria == 'nome'){
$busca_query = mysql_query("SELECT * FROM pedidos INNER JOIN clientes ON pedidos.id_cliente = clientes.id_cliente WHERE clientes.nome_cliente LIKE '%$busca%' and valor_pago != '0' ORDER BY pedidos.id_pedidos DESC"); 
}
if ($categoria == 'cpf') {
$busca_query = mysql_query("SELECT * FROM pedidos INNER JOIN clientes ON pedidos.id_cliente = clientes.id_cliente WHERE clientes.cpf LIKE '%$busca%' and valor_pago != '0' ORDER BY pedidos.id_pedidos DESC");
	}
if ($categoria == 'cnpj') {
$busca_query = mysql_query("SELECT * FROM pedidos INNER JOIN clientes ON pedidos.id_cliente = clientes.id_cliente WHERE clientes.cnpj LIKE '%$busca%' and valor_pago != '0' ORDER BY pedidos.id_pedidos DESC");
	}
